...
1. How would you describe acessibility on the web to someone new to programming?
   acessibility on the web is to have anyone can interact with the website with no barries. Acessibility should incluedes everyone, which is also means good design and good usability.

2. Talk about 3 different things you can do to ensure your website is accessible.

- use semantic tags, it provide defaults or shortcuts to a more usable web and accessible web.
- Include proper alt text for images and use the correct headings.
- Use color with care and keep colour contrast in mind.

3. How would you explain the concept of a variable to someone new to programming?
   variable is a way to store values and use it later in the program.

4. What is the purpose of using functions in code?
   function is reusable code that can perform a single, related action.
